 ...
 */
class DefaultPolymerRenderer implements Renderer {
    constructor(
 ...
 */
class EmulatedEncapsulationPolymerRenderer extends DefaultPolymerRenderer {
 ...
 */
class ShadowDomPolymerRenderer extends DefaultPolymerRenderer {
